...
const fallbackResponses: { [key: string]: string } = {
  career: "Career mein saflta ke liye, apne skills ko hamesha behtar banate rahein aur naye opportunities ke liye taiyaar rahein.",
  love: "Prem sambandhon mein vishwas aur imandari sabse zaroori hai. Apne partner ko samay dein.",
